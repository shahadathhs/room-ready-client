...
import Error_404 from "../assets/lottie/Error-404.json";
        ...
        <div className="flex flex-col md:flex-row gap-5 justify-center items-center min-h-screen">
          ...
          <section className="flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
              ...
              <Link to='/' className="px-8 py-3 btn btn-outline border-2 text-blue-600 font-bold rounded dark:bg-indigo-400 dark:text-gray-900">Back to homepage</Link>
            </div>
          </section>
        </div>
      </div>
